...
cg::world::camera::camera() : theta(0.f), phi(0.f), height(1440.f), width(3440.f), aspect_ratio(3440.f / 1440.f), angle_of_view(1.04719f), z_near(0.001f), z_far(100.f), position(DirectX::XMVectorSet(0, 0, 0, 1))
{}
